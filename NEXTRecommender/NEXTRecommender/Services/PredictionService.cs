...
namespace NEXTRecommender.Services
{
    public class PredictionService : IPredictionService
    {
        ...
        public PredictionService(IPredictionRepository predicitonRepository)
        {
            _predictionRepository = predicitonRepository;
        }
        ...
        public List<CampsiteRatingPrediction> GetPrediciton(string userId, int[] campsites)
        {
            ...
            Console.WriteLine("=============== Returning Prediction ===============");
        ...
        public void TrainModel()
        {
            ...
            // Get training data
            IEnumerable<CampsiteRatingData> ratings = _predictionRepository.GetAllCampsiteRatingData();
            ...
            // Save the model
            var modelPath = Path.Combine(Environment.CurrentDirectory, "CampsiteRecommenderModel.zip");
